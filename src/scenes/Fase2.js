...
class Fase2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('mapa_caverna', '/assets/mapa_caverna.png');
    this.load.image('coracoes', '/assets/hud_coracoes.png');
    this.load.spritesheet('lina_frente', '/assets/sprites-sheeys/lina andando de frente-sprite-sheet.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('lina_costas', '/assets/sprites-sheeys/lina andando costas-sprite-sheet.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('lina_direita', '/assets/sprites-sheeys/lina andando direita-sprite-sheet.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('lina_esquerda', '/assets/sprites-sheeys/lina andando esquerda-sprite-sheet.png', { frameWidth: 64, frameHeight: 64 });
  }
